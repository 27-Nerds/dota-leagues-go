import { countryText } from './constants.js';

// ISO 3166-1 alpha-2 codes, sourced from the system iso-codes dataset.
// DisplayNames also recognizes historical aliases; it must not define membership.
const countryCodes = `AD AE AF AG AI AL AM AO AQ AR AS AT AU AW AX AZ BA BB BD BE
...
export const countries = countryCodes
  .map(code => ({ code, name: countryText(code) || code }))
